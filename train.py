...
def sanity_checks(args):
    ...
    if args.mlm:
        ...
        assert (args.student_type in ["albert", "roberta", "distilbert"]) and (args.teacher_type in ["albert", "roberta", "bert"])
    else:
...
def main():
    ...
    parser.add_argument(
        "--teacher_type", choices=["albert", "bert", "roberta", "gpt2"], required=True, help="Teacher type (BERT, RoBERTa)."
    )
